...
# filepath: ./modules/home/waybar-style.nix
#
# Waybar CSS theme (Catppuccin Mocha) and battery/power-profile script.
# Split from waybar.nix to keep layout config and style separate.
